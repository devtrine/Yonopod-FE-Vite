...
export function NotFoundPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#f8fafc] px-4 text-center">
      <div className="w-20 h-20 rounded-2xl bg-[#0F0A6B]/10 text-[#0F0A6B] flex items-center justify-center mb-6">
        <HardDrive size={36} />
      </div>
      ...
      <Link
        to="/dashboard"
        className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#0F0A6B] text-white text-sm font-medium hover:bg-[#161282] transition-colors shadow-sm"
      >
        <ArrowLeft size={16} />
        Back to Dashboard
      </Link>
